...
class MerweScaledSigmaPoints(object):
    ...
    def _compute_weights(self):
        ...
        self.Wc = np.full(2*self.n + 1, 0.5/(self.n + self.kappa))
        self.Wm = np.full(2*self.n + 1, 0.5/(self.n + self.kappa))
        self.Wc[0] = self.kappa/(self.n + self.kappa)
        self.Wm[0] = self.kappa/(self.n + self.kappa)
