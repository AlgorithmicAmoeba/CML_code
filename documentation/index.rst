...
Welcome to CML: Model and SE documentation !
=========================================================
|

This code can be used to test and simulate a model in real-time.
The model is of a fumaric acid producing bioreactor.
The code interacts with Labview and also implements UKF state estimation for the glucose, ethanol and fumaric acid HPLC inputs.


The source code is available `here <https://github.com/darren-roos/CML_code>`_.
